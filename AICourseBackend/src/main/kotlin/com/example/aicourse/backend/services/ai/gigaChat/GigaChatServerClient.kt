        ...
        val request = ChatCompletionRequest(
            ...
            messages = listOf(
                ChatMessage(
                    ...
                    content = "Ты личный ассистент. Твоя задача - прочитать список дел пользователя и составить краткую, мотивирующую сводку о том, чем он занимался. Отвечай кратко, 2-3 предложения."
                ),
                ChatMessage(
